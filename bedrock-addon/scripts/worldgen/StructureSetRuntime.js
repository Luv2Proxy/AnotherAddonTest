...
export class StructureSetRuntime {
  constructor(generator, options = {}) {
    ...
    this.active = new Map(); this.pending = []; this.pendingKeys = new Set();
    this.seed = generator?.layoutSeed ?? 0n;
  }
  refresh(){this.registry=this.generator?.registry??this.registry;this.planner.registry=this.registry;this.sets=this.registry.structureSetIds?.()??[...this.registry.structureSets.keys()];this.seed=this.generator?.layoutSeed??this.seed;return this;}
